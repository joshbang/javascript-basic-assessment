...
function snakeAttributes(snake) {
...
var heroes = ['spongebob', 'batman', 'wonderwoman'];
...
function removeItem(arrayOfStrings, str) {
	for(var i = arrayOfStrings.length - 1; i >= 0; i--) {
		if(arrayOfStrings[i] === str) {
...
function getValueOfProperty(obj, param1) {
	return obj[param1];
